...
class PhysicsSimulationLocal : public PhysicsSimulationVisual, public PhysicsSimulationActions {
protected:
...
public:
    PhysicsSimulationLocal(sf::RenderWindow& win) : PhysicsSimulationVisual(), PhysicsSimulationActions(),
        window(win),
        settings(8),
