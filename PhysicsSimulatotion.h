...
//};
//
//class PhysicsSimulationVisual : public PhysicsSimulation {
//public:
//    PhysicsSimulationLocal(sf::RenderWindow& win) : PhysicsSimulation(win) {
//        initializeCursors();
//        loadResources();
//        initializeUI();
//        setupGradient();
...
public:
    PhysicsSimulationLocal(sf::RenderWindow& win) :
        window(win),
        settings(8),
        objectList(lineLength),
        spawnStartingPoint(posXStartingPoint, posYStartingPoint)
